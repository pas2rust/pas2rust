...
| [**nekopas2rust**](https://github.com/pas2rust/nekopas2rust) | provides a set of opt-in, feature-gated procedural #[derive(...)] macros that remove boilerplate and speed up common Rust patterns. Each macro is behind a Cargo feature so you only compile what you need: Builder, Parser, Cipher, Math, Print, Search and Sql. The crate is focused on ergonomics and DX for library and application authors who prefer generated, type-safe helpers over repetitive hand-written code. | [![Crates.io](https://img.shields.io/crates/v/nekopas2rust.svg)](https://crates.io/crates/nekopas2rust) [![Docs.rs](https://docs.rs/nekopas2rust/badge.svg)](https://docs.rs/nekopas2rust) [![License](https://img.shields.io/crates/l/nekopas2rust.svg)](https://github.com/pas2rust/nekopas2rust/blob/main/LICENSE) ![GitHub top language](https://img.shields.io/github/languages/top/pas2rust/nekopas2rust?color=orange&logo=rust&style=flat&logoColor=white) ![GitHub stars](https://img.shields.io/github/stars/pas2rust/nekopas2rust?color=success&style=flat&logo=github) ![GitHub forks](https://img.shields.io/github/forks/pas2rust/nekopas2rust?color=orange&logo=Furry%20Network&style=flat&logoColor=white) ![Tests](https://raw.githubusercontent.com/pas2rust/badges/main/nekopas2rust-tests.svg) ![Crates.io downloads](https://img.shields.io/crates/d/nekopas2rust.svg) [![Last commit](https://img.shields.io/github/last-commit/pas2rust/nekopas2rust?color=ff69b4&label=update&logo=git&style=flat&logoColor=white)](https://github.com/pas2rust/nekopas2rust/commits/main) |
